-- Media Tracker Database Seed Script
-- Populates the database with:
--  - 41 users (including an admin account)
--  - User privacy settings and badges
--  - Social friendships
--  - Media ratings and deep reviews (with fixed MangaDex cover URLs)
--  - Watchlist entries across Movies, TV Shows, Games, and Manga
--  - Custom user lists and ranked items
--  - Activity feed records
--  - Aggregated media stats
--  - User stats cache
--  - System diagnostic logs (info, warn, error)
--  - Background jobs (completed, pending, failed)
--  - Activity log history

-- 1. Insert Users
INSERT INTO public.users (id, username, name, email, "realName", "stateRegion", country, "showcaseBadges", role, image, created_at)
VALUES
  ('a0000000-0000-0000-0000-000000000001', 'admin', 'System Admin', 'admin@mediatracker.local', 'System Administrator', 'Central', 'United States', ARRAY['early_adopter', 'veteran', 'critic'], 'admin', 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150', NOW() - INTERVAL '60 days'),
  ('a1111111-1111-1111-1111-111111111111', 'alec_turner', 'Alec Turner', 'alec.turner@example.com', 'Alexander Turner', 'Greater London', 'United Kingdom', ARRAY['early_adopter', 'critic', 'century_club'], 'admin', 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=150', NOW() - INTERVAL '45 days'),
...
FROM public.users u
WHERE u.id >= 'a0000000-0000-0000-0000-000000000000'
...
-- 4. Friendships among Seed Users
...
FROM (VALUES
  (gen_random_uuid(), 'a1111111-1111-1111-1111-111111111111', 'a0000000-0000-0000-0000-000000000001', 'ACCEPTED', NOW() - INTERVAL '20 days', NOW() - INTERVAL '19 days'),
  (gen_random_uuid(), 'a2222222-2222-2222-2222-222222222222', 'a0000000-0000-0000-0000-000000000001', 'ACCEPTED', NOW() - INTERVAL '18 days', NOW() - INTERVAL '17 days'),
  (gen_random_uuid(), 'a3333333-3333-3333-3333-333333333333', 'a0000000-0000-0000-0000-000000000001', 'ACCEPTED', NOW() - INTERVAL '15 days', NOW() - INTERVAL '14 days'),
  (gen_random_uuid(), 'a4444444-4444-4444-4444-444444444444', 'a0000000-0000-0000-0000-000000000001', 'ACCEPTED', NOW() - INTERVAL '12 days', NOW() - INTERVAL '11 days'),
  (gen_random_uuid(), 'c3333333-3333-3333-3333-333333333333', 'a0000000-0000-0000-0000-000000000001', 'ACCEPTED', NOW() - INTERVAL '4 days', NOW() - INTERVAL '3 days'),
  (gen_random_uuid(), 'c2222222-2222-2222-2222-222222222222', 'a0000000-0000-0000-0000-000000000001', 'ACCEPTED', NOW() - INTERVAL '5 days', NOW() - INTERVAL '4 days'),
  (gen_random_uuid(), 'd5555555-5555-5555-5555-555555555555', 'a0000000-0000-0000-0000-000000000001', 'ACCEPTED', NOW() - INTERVAL '7 days', NOW() - INTERVAL '6 days'),
  (gen_random_uuid(), 'd6666666-6666-6666-6666-666666666666', 'a0000000-0000-0000-0000-000000000001', 'ACCEPTED', NOW() - INTERVAL '8 days', NOW() - INTERVAL '7 days'),
  (gen_random_uuid(), 'e9999999-9999-9999-9999-999999999999', 'a0000000-0000-0000-0000-000000000001', 'ACCEPTED', NOW() - INTERVAL '3 days', NOW() - INTERVAL '2 days'),
  (gen_random_uuid(), 'a5555555-5555-5555-5555-555555555555', 'a0000000-0000-0000-0000-000000000001', 'PENDING', NOW() - INTERVAL '1 day', NOW() - INTERVAL '1 day'),
  (gen_random_uuid(), 'a7777777-7777-7777-7777-777777777777', 'a0000000-0000-0000-0000-000000000001', 'PENDING', NOW() - INTERVAL '6 hours', NOW() - INTERVAL '6 hours'),
  (gen_random_uuid(), 'f1111111-1111-1111-1111-111111111111', 'a0000000-0000-0000-0000-000000000001', 'PENDING', NOW() - INTERVAL '2 hours', NOW() - INTERVAL '2 hours'),
  (gen_random_uuid(), 'a0000000-0000-0000-0000-000000000001', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'PENDING', NOW() - INTERVAL '12 hours', NOW() - INTERVAL '12 hours'),
  (gen_random_uuid(), 'a0000000-0000-0000-0000-000000000001', 'd1111111-1111-1111-1111-111111111111', 'PENDING', NOW() - INTERVAL '10 hours', NOW() - INTERVAL '10 hours'),
...
VALUES
  ...
  -- Chainsaw Man (Manga - Using Modern MangaDex Uploads CDN URL)
  (gen_random_uuid(), 'a2222222-2222-2222-2222-222222222222', 'mangadex-manga-a77742b1-befd-49a4-bff5-1ad4e6b0ef7b', 'Chainsaw Man', 'https://uploads.mangadex.org/covers/e896c48c-3150-437d-ba57-d8567eb399ae/fa06e4e4-ef2a-477b-bfb6-a2a88793620b.jpg', 96, 'Fujimoto''s chaotic brilliance on full display. Cinematic paneling, unpredictable twists, and emotional depth.', 'yuki_m', 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=150', '{"art": 95, "pacing": 98, "characters": 96, "story": 95}'::jsonb, true, 3, NOW() - INTERVAL '20 days', '2018-12-03'),
  (gen_random_uuid(), 'a9999999-9999-9999-9999-999999999999', 'mangadex-manga-a77742b1-befd-49a4-bff5-1ad4e6b0ef7b', 'Chainsaw Man', 'https://uploads.mangadex.org/covers/e896c48c-3150-437d-ba57-d8567eb399ae/fa06e4e4-ef2a-477b-bfb6-a2a88793620b.jpg', 94, 'Part 1 is a rollercoaster that redefines modern shonen.', 'aiko_t', 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150', '{"art": 92, "pacing": 96, "characters": 94, "story": 94}'::jsonb, true, 1, NOW() - INTERVAL '14 days', '2018-12-03'),
  (gen_random_uuid(), 'bddddddd-dddd-dddd-dddd-dddddddddddd', 'mangadex-manga-a77742b1-befd-49a4-bff5-1ad4e6b0ef7b', 'Chainsaw Man', 'https://uploads.mangadex.org/covers/e896c48c-3150-437d-ba57-d8567eb399ae/fa06e4e4-ef2a-477b-bfb6-a2a88793620b.jpg', 92, 'Raw and unapologetic. Makima is one of the most chilling characters in modern manga.', 'lina_c', 'https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?w=150', '{"art": 90, "pacing": 94, "characters": 96, "story": 92}'::jsonb, true, 1, NOW() - INTERVAL '10 days', '2018-12-03'),

  -- Berserk (Manga - Using Modern MangaDex Uploads CDN URL)
  (gen_random_uuid(), 'a8888888-8888-8888-8888-888888888888', 'mangadex-manga-d1a9fdeb-f713-407f-960c-8326b586e6fd', 'Berserk', 'https://uploads.mangadex.org/covers/30196491-8fc2-4961-8886-a58f898b1b3e/1790f17f-9184-4a48-8928-c45de48b778e.jpg', 100, 'Kentaro Miura''s artwork is unparalleled. The Golden Age arc remains the greatest dark fantasy story ever told.', 'dmitri_v', 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150', '{"art": 100, "pacing": 98, "characters": 100, "story": 100}'::jsonb, true, 1, NOW() - INTERVAL '18 days', '1989-08-25'),
  (gen_random_uuid(), 'a2222222-2222-2222-2222-222222222222', 'mangadex-manga-d1a9fdeb-f713-407f-960c-8326b586e6fd', 'Berserk', 'https://uploads.mangadex.org/covers/30196491-8fc2-4961-8886-a58f898b1b3e/1790f17f-9184-4a48-8928-c45de48b778e.jpg', 99, 'Every double-page spread belongs in an art gallery.', 'yuki_m', 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=150', '{"art": 100, "pacing": 96, "characters": 100, "story": 100}'::jsonb, true, 1, NOW() - INTERVAL '25 days', '1989-08-25'),
  (gen_random_uuid(), 'f2222222-2222-2222-2222-222222222222', 'mangadex-manga-d1a9fdeb-f713-407f-960c-8326b586e6fd', 'Berserk', 'https://uploads.mangadex.org/covers/30196491-8fc2-4961-8886-a58f898b1b3e/1790f17f-9184-4a48-8928-c45de48b778e.jpg', 98, 'The sheer endurance of Guts is inspiring and tragic.', 'zoro_r', 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150', '{"art": 100, "pacing": 95, "characters": 100, "story": 98}'::jsonb, true, 1, NOW() - INTERVAL '5 days', '1989-08-25'),

  -- Jujutsu Kaisen (Manga - Using Modern MangaDex Uploads CDN URL)
  (gen_random_uuid(), 'e9999999-9999-9999-9999-999999999999', 'mangadex-manga-c52b2ce3-7f95-469c-96b0-474fb724fb49', 'Jujutsu Kaisen', 'https://uploads.mangadex.org/covers/f3f59f12-351a-4de7-bd51-696d0764d64e/920a8cba-7c5c-4284-84c6-1c27cd2a3c0a.jpg', 94, 'Shibuya Incident arc is one of the most intense continuous battles in manga history.', 'gojo_s', 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=150', '{"art": 92, "pacing": 96, "characters": 96, "story": 92}'::jsonb, true, 1, NOW() - INTERVAL '8 days', '2018-03-05'),
  (gen_random_uuid(), 'a9999999-9999-9999-9999-999999999999', 'mangadex-manga-c52b2ce3-7f95-469c-96b0-474fb724fb49', 'Jujutsu Kaisen', 'https://uploads.mangadex.org/covers/f3f59f12-351a-4de7-bd51-696d0764d64e/920a8cba-7c5c-4284-84c6-1c27cd2a3c0a.jpg', 91, 'Cursed technique power system is deep and inventive.', 'aiko_t', 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150', '{"art": 90, "pacing": 92, "characters": 94, "story": 90}'::jsonb, true, 2, NOW() - INTERVAL '13 days', '2018-03-05'),

  -- One Piece (Manga - Using Modern MangaDex Uploads CDN URL)
  (gen_random_uuid(), 'f1111111-1111-1111-1111-111111111111', 'mangadex-manga-a1c7c817-4e59-43b7-9365-09675a149a6f', 'One Piece', 'https://uploads.mangadex.org/covers/a1c7c817-4e59-43b7-9365-09675a149a6f/2f4aca53-64c7-46ac-ae85-3bc9b3169890.png', 100, 'Over 1100 chapters and Oda still delivers peak worldbuilding and emotional payoffs.', 'luffy_m', 'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?w=150', '{"art": 95, "pacing": 92, "characters": 100, "story": 100}'::jsonb, true, 1, NOW() - INTERVAL '7 days', '1997-07-22'),
  (gen_random_uuid(), 'a2222222-2222-2222-2222-222222222222', 'mangadex-manga-a1c7c817-4e59-43b7-9365-09675a149a6f', 'One Piece', 'https://uploads.mangadex.org/covers/a1c7c817-4e59-43b7-9365-09675a149a6f/2f4aca53-64c7-46ac-ae85-3bc9b3169890.png', 98, 'The Enies Lobby and Marineford arcs are legendary.', 'yuki_m', 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=150', '{"art": 94, "pacing": 90, "characters": 100, "story": 100}'::jsonb, true, 4, NOW() - INTERVAL '16 days', '1997-07-22'),

  -- Madame Web (Negative review sample)
...
VALUES
  ...
  (gen_random_uuid(), 'a8888888-8888-8888-8888-888888888888', 'mangadex-manga-d1a9fdeb-f713-407f-960c-8326b586e6fd', 'Berserk', 'https://uploads.mangadex.org/covers/30196491-8fc2-4961-8886-a58f898b1b3e/1790f17f-9184-4a48-8928-c45de48b778e.jpg', 'COMPLETED', 364, 0, 41, 'MANGA', 0.0, 'Paperback', 1, NOW() - INTERVAL '30 days', NOW() - INTERVAL '100 days', NOW() - INTERVAL '18 days'),
  ...
  (gen_random_uuid(), 'f1111111-1111-1111-1111-111111111111', 'mangadex-manga-a1c7c817-4e59-43b7-9365-09675a149a6f', 'One Piece', 'https://uploads.mangadex.org/covers/a1c7c817-4e59-43b7-9365-09675a149a6f/2f4aca53-64c7-46ac-ae85-3bc9b3169890.png', 'COMPLETED', 1100, 0, 108, 'MANGA', 0.0, 'Shonen Jump', 1, NOW() - INTERVAL '10 days', NOW() - INTERVAL '365 days', NOW() - INTERVAL '7 days'),
  ...
  (gen_random_uuid(), 'a2222222-2222-2222-2222-222222222222', 'mangadex-manga-a77742b1-befd-49a4-bff5-1ad4e6b0ef7b', 'Chainsaw Man', 'https://uploads.mangadex.org/covers/e896c48c-3150-437d-ba57-d8567eb399ae/fa06e4e4-ef2a-477b-bfb6-a2a88793620b.jpg', 'IN_PROGRESS', 152, 0, 16, 'MANGA', 0.0, 'MangaPlus', 0, NOW() - INTERVAL '20 days', NOW() - INTERVAL '19 days', NULL),
  ...
  (gen_random_uuid(), 'e9999999-9999-9999-9999-999999999999', 'mangadex-manga-c52b2ce3-7f95-469c-96b0-474fb724fb49', 'Jujutsu Kaisen', 'https://uploads.mangadex.org/covers/f3f59f12-351a-4de7-bd51-696d0764d64e/920a8cba-7c5c-4284-84c6-1c27cd2a3c0a.jpg', 'IN_PROGRESS', 250, 0, 27, 'MANGA', 0.0, 'Shonen Jump', 0, NOW() - INTERVAL '15 days', NOW() - INTERVAL '14 days', NULL),
...
VALUES
  ...
  (gen_random_uuid(), 'a8888888-8888-8888-8888-888888888888', 'RATED_MEDIA', 'mangadex-manga-d1a9fdeb-f713-407f-960c-8326b586e6fd', 'Berserk', 'https://uploads.mangadex.org/covers/30196491-8fc2-4961-8886-a58f898b1b3e/1790f17f-9184-4a48-8928-c45de48b778e.jpg', 'MANGA', '{"score": 100}'::jsonb, NOW() - INTERVAL '2 days'),
  ...
  (gen_random_uuid(), 'e9999999-9999-9999-9999-999999999999', 'RATED_MEDIA', 'mangadex-manga-c52b2ce3-7f95-469c-96b0-474fb724fb49', 'Jujutsu Kaisen', 'https://uploads.mangadex.org/covers/f3f59f12-351a-4de7-bd51-696d0764d64e/920a8cba-7c5c-4284-84c6-1c27cd2a3c0a.jpg', 'MANGA', '{"score": 94}'::jsonb, NOW() - INTERVAL '4 days'),
  (gen_random_uuid(), 'f1111111-1111-1111-1111-111111111111', 'RATED_MEDIA', 'mangadex-manga-a1c7c817-4e59-43b7-9365-09675a149a6f', 'One Piece', 'https://uploads.mangadex.org/covers/a1c7c817-4e59-43b7-9365-09675a149a6f/2f4aca53-64c7-46ac-ae85-3bc9b3169890.png', 'MANGA', '{"score": 100}'::jsonb, NOW() - INTERVAL '4 days')
ON CONFLICT DO NOTHING;

-- 9. Refresh media_stats
...
-- 11. Insert System Diagnostic Logs
INSERT INTO public."SystemLog" (id, level, event, message, "requestId", "userId", "mediaId", "mediaType", "jobId", "durationMs", metadata, "errorName", "errorMessage", "createdAt")
VALUES
  ('log-seed-001', 'info', 'api.request', 'Fetched popular movies successfully', 'req-d89f1a', 'a1111111-1111-1111-1111-111111111111', 'tmdb-movie-157336', 'MOVIE', NULL, 42, '{"route": "/api/media/trending", "source": "TMDB"}'::jsonb, NULL, NULL, NOW() - INTERVAL '5 hours'),
  ('log-seed-002', 'info', 'auth.oauth_sync', 'OAuth user login and sync verified', 'req-e01c2b', 'a1111111-1111-1111-1111-111111111111', NULL, NULL, NULL, 95, '{"provider": "discord"}'::jsonb, NULL, NULL, NOW() - INTERVAL '4 hours 30 minutes'),
  ('log-seed-003', 'info', 'cache.hit', 'ApiCache hit for trending games', 'req-f44e11', NULL, 'igdb-game-119133', 'GAME', NULL, 3, '{"cacheKey": "trending_games_page_1"}'::jsonb, NULL, NULL, NOW() - INTERVAL '3 hours'),
  ('log-seed-004', 'info', 'worker.job_executed', 'Job award_badges executed successfully', 'req-a912bb', 'a2222222-2222-2222-2222-222222222222', NULL, NULL, 'job-seed-001', 315, '{"badgesAwarded": ["century_club"]}'::jsonb, NULL, NULL, NOW() - INTERVAL '2 hours 15 minutes'),
  ('log-seed-005', 'warn', 'cache.miss_slow_upstream', 'External upstream API response delayed', 'req-b521cc', NULL, 'mangadex-manga-a77742b1-befd-49a4-bff5-1ad4e6b0ef7b', 'MANGA', NULL, 2450, '{"upstream": "MangaDex", "endpoint": "/manga"}'::jsonb, NULL, NULL, NOW() - INTERVAL '1 hour 45 minutes'),
  ('log-seed-006', 'warn', 'rate_limit.warning', 'User approaching rate limit threshold', 'req-c782dd', 'a3333333-3333-3333-3333-333333333333', NULL, NULL, NULL, 12, '{"requestsInMinute": 85, "limit": 100}'::jsonb, NULL, NULL, NOW() - INTERVAL '1 hour 10 minutes'),
  ('log-seed-007', 'error', 'upstream.api_timeout', 'Failed to retrieve media credits from upstream provider', 'req-e331aa', NULL, 'tmdb-movie-872585', 'MOVIE', NULL, 5012, '{"upstream": "TMDB", "action": "fetchCredits"}'::jsonb, 'SocketTimeoutException', 'Connect timed out to api.themoviedb.org after 5000ms', NOW() - INTERVAL '40 minutes'),
  ('log-seed-008', 'info', 'admin.cache.cleanup', 'Cleaned expired entries from ApiCache table', 'req-ad9911', 'a0000000-0000-0000-0000-000000000001', NULL, NULL, NULL, 58, '{"deletedCount": 14}'::jsonb, NULL, NULL, NOW() - INTERVAL '20 minutes'),
  ('log-seed-009', 'info', 'rankings.sweep_completed', 'PageRank global sweep finished', 'req-ff7722', NULL, NULL, NULL, 'job-seed-004', 820, '{"itemsProcessed": 16, "iterations": 15}'::jsonb, NULL, NULL, NOW() - INTERVAL '10 minutes')
ON CONFLICT (id) DO NOTHING;

-- 12. Insert Background Jobs
INSERT INTO public."BackgroundJob" (id, type, payload, status, dedupe_key, attempts, max_attempts, run_at, created_at, updated_at, processed_at, last_error)
VALUES
  ('job-seed-001', 'award_badges', '{"userId": "a2222222-2222-2222-2222-222222222222"}'::jsonb, 'completed', 'award_badges_a2222222', 1, 3, NOW() - INTERVAL '3 hours', NOW() - INTERVAL '3 hours', NOW() - INTERVAL '2 hours 15 minutes', NOW() - INTERVAL '2 hours 15 minutes', NULL),
  ('job-seed-002', 'update_user_stats', '{"userId": "a1111111-1111-1111-1111-111111111111", "mediaType": "MOVIE"}'::jsonb, 'completed', 'update_stats_a111_movie', 1, 3, NOW() - INTERVAL '2 hours', NOW() - INTERVAL '2 hours', NOW() - INTERVAL '1 hour 50 minutes', NOW() - INTERVAL '1 hour 50 minutes', NULL),
  ('job-seed-003', 'recalculate_ranks', '{}'::jsonb, 'completed', 'recalc_ranks_daily', 1, 3, NOW() - INTERVAL '1 hour', NOW() - INTERVAL '1 hour', NOW() - INTERVAL '50 minutes', NOW() - INTERVAL '50 minutes', NULL),
  ('job-seed-004', 'sweep_ranks', '{}'::jsonb, 'completed', 'sweep_ranks_seed', 1, 3, NOW() - INTERVAL '15 minutes', NOW() - INTERVAL '15 minutes', NOW() - INTERVAL '10 minutes', NOW() - INTERVAL '10 minutes', NULL),
  ('job-seed-005', 'update_user_stats', '{"userId": "a3333333-3333-3333-3333-333333333333", "mediaType": "GAME"}'::jsonb, 'pending', 'update_stats_a333_game', 0, 3, NOW(), NOW(), NOW(), NULL, NULL),
  ('job-seed-006', 'award_badges', '{"userId": "f1111111-1111-1111-1111-111111111111"}'::jsonb, 'failed', 'award_badges_f1111111', 3, 3, NOW() - INTERVAL '30 minutes', NOW() - INTERVAL '30 minutes', NOW() - INTERVAL '25 minutes', NULL, 'Connection reset by peer while contacting external badge registry')
ON CONFLICT (id) DO NOTHING;

-- 13. Insert Activity Log History
INSERT INTO public.activity_log (id, user_id, media_id, increment, created_at)
VALUES
  (gen_random_uuid(), 'a1111111-1111-1111-1111-111111111111', 'tmdb-tv-94605', '+1 episode', NOW() - INTERVAL '25 days'),
  (gen_random_uuid(), 'a2222222-2222-2222-2222-222222222222', 'tmdb-tv-1429', '+5 episodes', NOW() - INTERVAL '32 days'),
  (gen_random_uuid(), 'a3333333-3333-3333-3333-333333333333', 'igdb-game-119133', '+12 hours', NOW() - INTERVAL '24 days'),
  (gen_random_uuid(), 'a8888888-8888-8888-8888-888888888888', 'mangadex-manga-d1a9fdeb-f713-407f-960c-8326b586e6fd', '+20 chapters', NOW() - INTERVAL '19 days'),
  (gen_random_uuid(), 'f1111111-1111-1111-1111-111111111111', 'mangadex-manga-a1c7c817-4e59-43b7-9365-09675a149a6f', '+15 chapters', NOW() - INTERVAL '8 days')
ON CONFLICT DO NOTHING;
